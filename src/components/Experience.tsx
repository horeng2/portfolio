const Experience = () => (
  <section id="experience" className="border-t border-slate-800 pt-10 pb-12 scroll-mt-10">
    <h2 className="text-lg sm:text-xl font-semibold text-center">Experience</h2>
    ...
    <div className="mt-6 text-sm text-left">
      <article className="mx-auto max-w-[734px] rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-sm">
        <header>
          <h3 className="text-sm sm:text-base font-semibold text-slate-50">정육각 – 프론트엔드 개발자</h3>

          <p className="mt-1 text-xs sm:text-sm font-medium text-slate-300 leading-relaxed">
            정육각 커머스 웹 · iOS 개발 / 자회사(초록마을) 시스템 개발
          </p>

          <p className="mt-0.5 text-xs text-slate-400">2022.12. ~ 2025.07. (2년 8개월)</p>
        </header>

        <ul className="mt-4 list-disc space-y-2 pl-5 text-xs leading-relaxed text-slate-100 marker:text-slate-500 text-xs sm:text-sm">
